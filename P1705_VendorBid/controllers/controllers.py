...
class SupplierRegistration(http.Controller):
    ...
    def show_supplier_registration(self):
        ...
        return request.render('P1705_VendorBid.portal_supplier_registration', ctx)
    ...
    def submit_registration(self, **post):
        ...
        try:
            ...
            for reviewer in reviewers:
                template = request.env.ref('P1705_VendorBid.email_template_model_supplies_vendor_registration_reviewer').sudo()
                ...
                utils.format_response(
                    ...
                    'Registration successful',
                    {
                        'html': utils.render_qweb_template(
                            request.env,
                            'P1705_VendorBid.supplier_registration_success'
                        )
                    }
                )
            )
